...
class ResNet(nn.Module):
    ...
    Reference:
        ...
        - Xie et al. Aggregated Residual Transformations for
    ...
    def _construct_fc_layer(self, fc_dims, input_dim, dropout_p=None):
        ...
        Args:
            fc_dims (list or tuple): dimensions of fc layers,
            if None, no fc layers are constructed
...
def init_pretrained_weights(model, model_url):
    ...
    Layers that don't match with pretrained layers
    in name or size are kept unchanged.
    """
