...
class WarmupMultiStepLR(torch.optim.lr_scheduler._LRScheduler):
    """
        Adapted from: "https://github.com/michuanhaohao/reid-strong-baseline/blob/master/solver/lr_scheduler.py".
        Multi-step learning rate with warm-up.
    """
    def __init__(
        self,
        optimizer,
    ...
    def get_lr(self):
        ...
        if self.last_epoch < self.warmup_iters:
            if self.warmup_method == "constant":
                ...
                warmup_factor = (self.last_epoch + 1) / self.warmup_iters
        return [
            base_lr
            * warmup_factor
...
def build_lr_scheduler(
    optimizer, lr_scheduler='single_step', stepsize=1, gamma=0.1, max_epoch=1, **kwargs
):
    ...
    if lr_scheduler == 'single_step':
        ...
        scheduler = WarmupMultiStepLR(
            optimizer, milestones=stepsize, gamma=gamma, **kwargs
        )
